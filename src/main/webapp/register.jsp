...
<base href="${base}/" />
<meta charset="utf-8" />
<title>用户注册_海购网</title>
<jsp:include page="base.jsp" />
<link rel="stylesheet" type="text/css" href="css/index.css" />
<script type="text/javascript">
	function checkName(name){
		$.get("user_isExist?user.name="+name,function(r){
			//alert(r);
			if(r=="true"){
						...
						<table class="form_table f_l">
							...
							<tr>
								...
								<td><input class="gray" name='user.name' id="name"
									type="text" value="${name}" tabindex="1" onblur="checkName(this.value)"/><label id="namemsg">请填写用户名，格式为2-20个字符，可以为字数，数字下划线和中文</label></td>
							</tr>
							<tr>
								<th>设置密码：</th>
								<td><input class="gray" type="password"
									name='user.password' tabindex="2" /><label>填写登录密码，6-32个字符</label></td>
							</tr>
							<tr>
								<th>确认密码：</th>
								<td><input class="gray" type="password" name='repassword'
									tabindex="3" /><label>重复上面所填写的密码</label></td>
							</tr>
							<tr>
								<th>手机号码：</th>
								<td><input class="gray" name='user.phoneNum' type="text" tabindex="4" ><label></label></td>
							</tr>
							<tr>
								<td></td>
